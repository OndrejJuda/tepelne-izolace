...
const Footer = () => {
  return (
    ...
    px-36 py-32 bg-primary-50 relative overflow-hidden'>
      <img
        src='/logo/logo-one-color.svg'
        alt='logo'
        className='absolute right-[50%] top-0 translate-x-[50%] scale-125'
      />
      <Link href='/' className='mr-auto z-10'>
        <img src='/logo/logo-name.png' alt='logo' width={300} />
      </Link>
      <div className='flex gap-16 text-primary-500 font-medium text-lg'>
        <div>
          <p>LUNASTAV s.r.o.</p>
          <p>IČO: 00000000</p>
