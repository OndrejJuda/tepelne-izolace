...
const Process = () => {
  return (
    ...
    >
      <HSecondary additionalStyling='text-4xl md:text-5xl mb-32 text-center'>Náš proces: Jak vám poskytneme nejlepší služby v oblasti foukané izolace</HSecondary>
