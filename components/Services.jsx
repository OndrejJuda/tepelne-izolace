...
const Services = () => {
  return (
    ...
    >
      ...
      <div className='mx-8 md:mx-16 lg:mx-36 bg-secondary-600 rounded-lg overflow-hidden shadow-xl 2xl:flex'>
        <div>
          ...
          <div className='flex flex-col xl:flex-row'>
            <div
              className='p-8 lg:p-20 2xl:pt-0
              flex-1 flex flex-col justify-center order-2'
            >
